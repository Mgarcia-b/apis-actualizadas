...
//Conexión
require "../db/dbs.php";
  $query = "SELECT * FROM BITACORA.BITACORA_GG_CAMPANA_MES_AT WHERE (extract(month from FECHA_INSERT) = MONTH( current_date()));";
...
// /* FIN PRUEBAS */
  ...
  $mi_host = $_SERVER["HTTP_HOST"];
    ...
    $myfile = fopen("GG_MENSUAL_CAMPANA_CLARO.json", "w") or die("Error archivo");
    $txt = $json_pretty;
    fwrite($myfile, $txt);
    fclose($myfile);
    //Leemos el archivo creado
    $JsonParser = file_get_contents("GG_MENSUAL_CAMPANA_CLARO.json");
...
//inserta bandera en bitacora
        ...
        $insert_bitacora = "INSERT INTO `BITACORA`.`BITACORA_GG_CAMPANA_MES_AT` (`FLAG`, `NOMBRE_JSON`) VALUES ('1', 'GG_MENSUAL_CAMPANA_CLARO');";
      ...
      foreach ($jsomp2["data"][$id_1] as $value1) {
       ...
       // INSERT DE LOS DATOS
        ...
        //echo "Connected successfully";
         ...
         $sql = " INSERT INTO `DBCLARO`.`GG_CAMPANA_MES_AT` ( `Account ID`, `Account`,
         `Campaign name`, `Campaign status`, `Bidding strategy type`, `Year & month`, `Start date`,
          ...
          VALUES ('GG_MENSUAL_CAMPANA_CLARO', '".$RepInsertSF."', '".$RepInsertER."');";
