...
//Conexión
require "../db/dbs.php";
  $query = "SELECT * FROM BITACORA.BITACORA_LINK_CAMPANA_MES_AT WHERE (extract(month from FECHA_INSERT) = MONTH( current_date()));";
  ...
  //solicita fecha para insertar ultimo Dia
...
// /* FIN PRUEBAS */
  ...
  $mi_host = $_SERVER["HTTP_HOST"];
    ...
    $myfile = fopen("LK_MENSUAL_CAMPANA_CLARO.json", "w") or die("Error archivo");
    $txt = $json_pretty;
    fwrite($myfile, $txt);
    fclose($myfile);
    //Leemos el archivo creado
    $JsonParser = file_get_contents("LK_MENSUAL_CAMPANA_CLARO.json");
...
//inserta bandera en bitacora
        ...
        $insert_bitacora = "INSERT INTO `BITACORA`.`BITACORA_LINK_CAMPANA_MES_AT` (`FLAG`, `NOMBRE_JSON`) VALUES ('1', 'LK_MENSUAL_CAMPANA_CLARO');";
      ...
      foreach ($jsomp2["data"][$id_1] as $value1) {
       ...
       // INSERT DE LOS DATOS
        ...
        //echo "Connected successfully";
         ...
         $sql = " INSERT INTO `DBCLARO`.`LINK_CAMPANA_MES_AT` (`Account name`, 
         `Account ID`, `Campaign name`, `Campaign status`, `Campaign start date`,
          ...
          '$dato23' ,'$dato24'  ,'$dato25'  ,'$dato26'  ,'$dato27'  );";
        ...
        VALUES ('LK_MENSUAL_CAMPANA_CLARO', '".$RepInsertSF."', '".$RepInsertER."');";
