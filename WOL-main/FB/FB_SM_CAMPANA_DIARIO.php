...
//Conexión
require "../db/dbs.php";
  $query = "SELECT * FROM BITACORA.BITACORA_FB_CAMPANA_AT WHERE (extract(day from FECHA_INSERT) = DAY( current_date()));";
...
// /* FIN PRUEBAS */
  ...
  $mi_host = $_SERVER["HTTP_HOST"];
    ...
    $myfile = fopen("FB_DIARIO_CAMPANA_CLARO.json", "w") or die("Error archivo");
    $txt = $json_pretty;
    fwrite($myfile, $txt);
    fclose($myfile);
    //Leemos el archivo creado
    $JsonParser = file_get_contents("FB_DIARIO_CAMPANA_CLARO.json");
...
//inserta bandera en bitacora
        ...
        $insert_bitacora = "INSERT INTO `BITACORA`.`BITACORA_FB_CAMPANA_AT` (`FLAG`, `NOMBRE_JSON`) VALUES ('1', 'FB_DIARIO_CAMPANA_CLARO');";
      ...
      foreach ($jsomp2["data"][$id_1] as $value1) {
       ...
       // INSERT DE LOS DATOS
        ...
        //echo "Connected successfully";
         ...
         $sql = " INSERT INTO `DBCLARO`.`FB_CAMPANA_AT` (`Fecha_insert`, `Account`, `Campaign name`, `Campaign start date`, `Campaign end date`, `Campaign status`,
          ...
          VALUES ('$dato13', '$dato0' ,'$dato1' ,'$dato2' ,'$dato3' ,'$dato4' ,
          '$dato5'  ,'$dato6'   ,'$dato7'   ,'$dato8'   ,'$dato9'   ,'$dato10'  ,
          '$dato11' ,'$dato12'  ,'$dato14'  ,'$dato15'  ,'$dato16'  ,
          ...
          VALUES ('FB_DIARIO_CAMPANA_CLARO', '".$RepInsertSF."', '".$RepInsertER."');";
