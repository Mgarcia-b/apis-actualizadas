...
//Conexión
require "../db/dbs.php";
  $query = "SELECT * FROM BITACORA.BITACORA_TT_CAMPANA_AT WHERE (extract(day from FECHA_INSERT) = DAY( current_date()));";
...
// /* FIN PRUEBAS */
  ...
  $mi_host = $_SERVER["HTTP_HOST"];
    ...
    $myfile = fopen("TT_DIARIO_CAMPANA_CLARO.json", "w") or die("Error archivo");
    $txt = $json_pretty;
    fwrite($myfile, $txt);
    fclose($myfile);
    //Leemos el archivo creado
    $JsonParser = file_get_contents("TT_DIARIO_CAMPANA_CLARO.json");
...
//inserta bandera en bitacora
        ...
        $insert_bitacora = "INSERT INTO `BITACORA`.`BITACORA_TT_CAMPANA_AT` (`FLAG`, `NOMBRE_JSON`) VALUES ('1', 'TT_DIARIO_CAMPANA_CLARO');";
  ...
  //Fin inserta bandera en bitacora
    ...
    while($id_1 <= $valorNetoTotal){
      ...
      foreach ($jsomp2["data"][$id_1] as $value1) {
       ...
       // INSERT DE LOS DATOS
        ...
        //echo "Connected successfully";
         ...
         $sql = " INSERT INTO `DBCLARO`.`TT_CAMPANA_AT` (`Fecha_insert`, `Account`, `Campaign`, 
      ...
      VALUES ('TT_DIARIO_CAMPANA_CLARO', '".$RepInsertSF."', '".$RepInsertER."');";
